...
class Candidato(models.Model):
    ...
    foto = models.ForeignKey(to='ArquivosFoto', on_delete="cascade", related_name="candidatos", null=True, blank=True) #onetomany
    
    #via token
    turma = models.ForeignKey(to='Turma', on_delete="cascade", related_name="candidatos", null=True, blank=True) #onetomany
    aluno = models.ForeignKey(to='Aluno', on_delete="cascade", related_name="candidatos", null=True, blank=True) #onetomany
