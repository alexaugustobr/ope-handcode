...
class Aluno(Usuario):
    curso = models.ForeignKey(to='Curso', on_delete="cascade", related_name="alunos", null=False, blank=False) #onetomany
    ...
    foto = models.ForeignKey(to='ArquivosFoto', on_delete="cascade", related_name="alunos", null=True, blank=True) #onetomany
