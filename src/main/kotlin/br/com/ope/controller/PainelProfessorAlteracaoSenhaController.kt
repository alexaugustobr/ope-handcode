...
@Controller
@RequestMapping(value = "/painel/professor/alterar-senha")
class PainelProfessorAlteracaoSenhaController(val usuarioRepository: UsuarioRepository) {
    ...
    fun indexAlterarSenha(model: Model, @AuthenticationPrincipal usuarioAutenticado: Usuario?, usuarioAlteracaoSenhaVO: UsuarioAlteracaoSenhaVO) : String {
        ...
        return "/painel/professor/alterar-senha/index"
    }
    ...
    fun alterarSenhaSalvar(model: Model,
        ...
        if (!usuarioOptional.isPresent) {
            ...
            return "redirect:/painel/professor/alterar-senha"
        }
