...
@Controller
@RequestMapping(value = "/painel/aluno/alterar-senha")
class PainelAlunoAlteracaoSenhaController(val usuarioRepository: UsuarioRepository) {
    ...
    fun indexAlterarSenha(model: Model, @AuthenticationPrincipal usuarioAutenticado: Usuario?, usuarioAlteracaoSenhaVO: UsuarioAlteracaoSenhaVO) : String {
        ...
        return "/painel/aluno/alterar-senha/index"
    }
    ...
    fun alterarSenhaSalvar(model: Model,
        ...
        if (!usuarioOptional.isPresent) {
            ...
            return "redirect:/painel/aluno/alterar-senha"
        }
